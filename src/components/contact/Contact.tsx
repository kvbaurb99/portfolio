...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="relative py-32 overflow-hidden">
      ...
      {/* Decorative orbs */}
      <motion.div
        className="absolute bottom-0 left-1/4 w-96 h-96 bg-[var(--accent-secondary)] rounded-full blur-[200px] opacity-10"
        animate={{
          scale: [1, 1.2, 1],
      ...
      />
      <motion.div
        className="absolute top-0 right-1/4 w-64 h-64 bg-[var(--accent-primary)] rounded-full blur-[150px] opacity-10"
        animate={{
          scale: [1.2, 1, 1.2],
